...
<head>
  ...
  <title>Connect eBay Guide — EcomTool</title>
  <style>
...
<body>
  <div class="card">
    <span class="badge">eBay Guide · EcomTool</span>
  ...
  <script>
    (function () {
      ...
      if (userId) {
        ...
        var message = { type: "ECOMTOOL_EBAY_GUIDE_CONNECT", source: "ecomtool", userId: userId };
        ...
        statusEl.textContent = "Your EcomTool account is linked. Return to the eBay Guide extension and close this tab.";
        idEl.textContent = userId;
        idEl.style.display = "block";
      } else {
        titleEl.textContent = "Not signed in";
        titleEl.className = "err";
        statusEl.textContent = "Sign in to EcomTool first, then click Connect again.";
