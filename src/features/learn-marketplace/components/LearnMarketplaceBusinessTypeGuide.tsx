...
export type PracticeRegisteredSubtype = "company" | "partnership" | "public";

export const REGISTERED_SUBTYPE_GUIDE_KEY = "learn_marketplace_registered_subtype_guide_ack";
export const REGISTERED_SUBTYPE_CURSOR_KEY_PREFIX = "learn_marketplace_registered_subtype_cursor_";
export const PRACTICE_REGISTERED_SUBTYPE_KEY = "learn_marketplace_practice_registered_subtype";

export function LearnMarketplaceRegisteredSubtypeGuide({
  visible,
  onDismiss,
}: {
  visible: boolean;
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/45 px-4 py-8">
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="registered-subtype-guide-title"
      ...
      >
        <div className="border-b border-gray-100 px-8 py-6">
          ...
          <h2
            id="registered-subtype-guide-title"
            className="mt-3 text-2xl font-bold tracking-tight text-[#191919]"
          >
            Choose your business type
          </h2>
          <p className="mt-3 text-sm leading-relaxed text-[#555]">
            From the dropdown, select <strong>only Company (e.g. LTD, Untd.)</strong> if your business
        ...
        <div className="space-y-3 px-8 py-6 text-left">
          <div className="rounded-xl border border-[#3665f3]/20 bg-[#f0f6ff] p-4">
            <p className="text-sm font-semibold text-[#191919]">Company (e.g. LTD, Untd.)</p>
            <p className="mt-1 text-sm leading-relaxed text-[#555]">
              Select this option for Ltd, LLC, or similar registered companies.
            </p>
          </div>
          <div className="rounded-xl border border-gray-100 bg-[#f7f7f7] p-4 opacity-80">
            <p className="text-sm font-semibold text-[#191919]">Other options</p>
            <p className="mt-1 text-sm leading-relaxed text-[#555]">
              Do not select Partnership or Publicly traded company during this practice.
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 px-8 py-6">
          <button
            type="button"
            onClick={() => {
              sessionStorage.setItem(REGISTERED_SUBTYPE_GUIDE_KEY, "true");
              onDismiss();
            }}
