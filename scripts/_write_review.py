...
# The content above accidentally duplicated again in the generator script's intent.
# Build CLEAN content only once below.
...
print('exports', OUT.read_text(encoding='utf-8').count('export function AmazefAutoListReviewPage'))
print('delivery sections', OUT.read_text(encoding='utf-8').count('Delivery &amp; handling'))
